...
> These notes preserve the 2019 development history and are not current API or
> release guidance. See `README.md` and the generated crate documentation for
> rust-lapper 2 behavior.
...
- Maybe add max_ends list to the Lapper. Then binary search for upper
  ...
  max_end to determine overlap... It could make the hopper actually
...
- Sped up the intersection method when we know that overlaps have been
  merged.
...
- Corrected the intersection_and_union function to work regardless of
  ...
  lappers have had overlaps merged, I'm just not sure how to make it
  work yet.
...
- I would like to add some whole Lapper functions like a union and
  intersection. -- did this... but needs fine tuning
